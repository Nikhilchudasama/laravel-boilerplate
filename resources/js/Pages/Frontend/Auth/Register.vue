      ...
      <div
        ...
        <form class="space-y-5" @submit.prevent="submit">
          ...
          <div>
            ...
            <p v-if="form.errors.name" class="mt-1.5 text-xs text-red-500 font-medium px-1">
              {{ form.errors.name }}
            </p>
          </div>
          ...
          <div class="flex items-center">
            ...
            <label for="terms" class="ml-2.5 block text-sm text-zinc-600 dark:text-zinc-400 select-none">
              I agree to the <a href="#" class="text-indigo-600 hover:text-indigo-500 underline font-medium">Terms of
                Service</a>
              and <a href="#" class="text-indigo-600 hover:text-indigo-500 underline font-medium">Privacy
                Policy</a>
            </label>
          </div>
          <p v-if="form.errors.terms" class="mt-1.5 text-xs text-red-500 font-medium px-1">
            {{ form.errors.terms }}
          </p>
          ...
          <div class="text-center">
            <p class="text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <Link href="/login" class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">
                Sign in instead
              </Link>
            </p>
          </div>
